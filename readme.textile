...
# Go to https://nodejs.org and download and run the Node installer for the operating system you're using
# After that's done run @sudo npm install npm -g@ just to be on the safe side to make sure you're using the latest node package manager
